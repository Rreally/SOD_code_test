...
class SOD360Dataset(Dataset):
    def __init__(self, img_dir, gt_path, input_size, train=True):
        ...
        for file_id in file_list:
            image_id = file_id.split(".")[0]
            img_file = os.path.join(self.img_dir, file_id)
            label_file = os.path.join(self.gt_path, image_id+'.png')
